...
.modal {
  width: 500px;
  background-color: rgb(90, 125, 169);
  border-radius: 10px;
  padding: 30px;
  position: relative;
  display: flex;
 ...
 .modal input{
  padding: 10px;
  border: 2px solid rgb(202, 117, 195);
 }
.modal button{
  padding: 10px 20px;
  font-size: 20px;
  width: 100%;
  background-color: rgb(81, 8, 129);
  border: none;
  color: rgb(112, 148, 224);
  cursor: pointer;
  margin-top: 15px;
}

.modal .close {
  color: rgb(56, 159, 191);
  font-weight: bold;
  background-color: rgb(60, 19, 164);
}
</style>